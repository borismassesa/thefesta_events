...
export default function Signup() {
  ...
  return (
    <div className="h-screen overflow-hidden w-full flex bg-background">
      ...
      <div className="hidden lg:flex w-1/2 relative overflow-hidden bg-black h-full">
        ...
        <div className="relative z-10 p-12 flex flex-col justify-between h-full text-white w-full">
          <div className="flex justify-between items-start">
            <Link href="/">
              <a className="font-serif text-4xl tracking-wide drop-shadow-sm hover:opacity-80 transition-opacity">
                TheFesta
              </a>
            </Link>
          </div>
      ...
      {/* Right Side - Form */}
      <div className="w-full lg:w-1/2 flex flex-col justify-center items-center p-8 sm:p-12 lg:p-24 pt-24 lg:pt-32 relative">
